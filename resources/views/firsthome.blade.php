...
<div class="wrapper white-wrapper">
  ...
  <div class="row gutter-60 text-center align-items-end">
      <div class="col-md-4">
        <figure class="mb-30"><img src="#" srcset="frontend/style/images/concept/concept14.png 1x, frontend/style/images/concept/concept14@2x.png 2x" alt="" /></figure>
        <h4>Social Media</h4>
    ...
    <div class="col-md-4">
        <figure class="mb-30"><img src="#" srcset="frontend/style/images/concept/concept19.png 1x, frontend/style/images/concept/concept19@2x.png 2x" alt="" /></figure>
    ...
    <div class="space20 d-md-none"></div>
    <div class="col-md-4">
        <figure class="mb-30"><img src="#" srcset="frontend/style/images/concept/concept18.png 1x, frontend/style/images/concept/concept18@2x.png 2x" alt="" /></figure>
...
<div class="row align-items-center">
  <div class="col-lg-6">
    <figure><img src="#" srcset="frontend/style/images/concept/concept15.png 1x, frontend/style/images/concept/concept15@2x.png 2x" alt="" /></figure>
</div>
<!--/column -->
<div class="space20 d-md-none"></div>
...
<div class="row align-items-center">
  <div class="col-lg-6 order-lg-2 text-center">
    <figure><img src="#" srcset="frontend/style/images/concept/concept17.png 1x, frontend/style/images/concept/concept17@2x.png 2x" alt="" /></figure>
</div>
<!--/column -->
<div class="space20 d-md-none"></div>
<div class="space50 d-none d-md-block d-lg-none"></div>
...
<!-- /.wrapper -->
<div class="wrapper image-wrapper bg-image gradient-overlay inverse-text" data-image-src="frontend/style/images/art/bg25.jpg">
...
<div class="wrapper light-wrapper">
  ...
  <div class="grid-view">
      <div class="carousel owl-carousel" data-margin="30" data-dots="true" data-autoplay="false" data-autoplay-timeout="5000" data-responsive='{"0":{"items": "1"}, "768":{"items": "2"}, "992":{"items": "3"}}'>
        <div class="item">
          <figure class="overlay overlay1 rounded mb-30"><a href="#"> <img src="frontend/style/images/art/b1.jpg" alt="" /></a>
            <figcaption>
  ...
  <!-- /.item -->
  <div class="item">
      <figure class="overlay overlay1 rounded mb-30"><a href="#"> <img src="frontend/style/images/art/b2.jpg" alt="" /></a>
        <figcaption>
          <h5 class="from-top mb-0">Read More</h5>
      </figcaption>
  </figure>
...
<!-- /.item -->
<div class="item">
  <figure class="overlay overlay1 rounded mb-30"><a href="#"> <img src="frontend/style/images/art/b3.jpg" alt="" /></a>
    <figcaption>
      <h5 class="from-top mb-0">Read More</h5>
  </figcaption>
</figure>
...
<!-- /.item -->
<div class="item">
  <figure class="overlay overlay1 rounded mb-30"><a href="#"> <img src="frontend/style/images/art/b4.jpg" alt="" /></a>
    <figcaption>
      <h5 class="from-top mb-0">Read More</h5>
  </figcaption>
</figure>
...
<!-- /.item -->
<div class="item">
  <figure class="overlay overlay1 rounded mb-30"><a href="#"> <img src="frontend/style/images/art/b5.jpg" alt="" /></a>
    <figcaption>
      <h5 class="from-top mb-0">Read More</h5>
  </figcaption>
</figure>
...
<div class="wrapper white-wrapper">
  ...
  <div class="row align-items-center">
      <div class="col-lg-6 pr-60 pr-md-15">
        <figure><img src="#" srcset="frontend/style/images/concept/concept16.png 1x, frontend/style/images/concept/concept16@2x.png 2x" alt="" /></figure>
    </div>
    <!--/column -->
    <div class="space20 d-md-none"></div>
    <div class="space50 d-none d-md-block d-lg-none"></div>
...
<div class="carousel owl-carousel clients" data-margin="30" data-loop="true" data-dots="false" data-autoplay="true" data-autoplay-timeout="3000" data-responsive='{"0":{"items": "2"}, "768":{"items": "4"}, "992":{"items": "5"}, "1140":{"items": "6"}}'>
  <div class="item pl-15 pr-15"><img src="{{ asset('frontend/style/images/art/z1.svg')}}" alt="" /></div>
  <div class="item pl-15 pr-15"><img src="{{ asset('frontend/style/images/art/z2.svg')}}" alt="" /></div>
  <div class="item pl-15 pr-15"><img src="{{ asset('frontend/style/images/art/z3.svg')}}" alt="" /></div>
  <div class="item pl-15 pr-15"><img src="{{ asset('frontend/style/images/art/z4.svg')}}" alt="" /></div>
  <div class="item pl-15 pr-15"><img src="{{ asset('frontend/style/images/art/z5.svg')}}" alt="" /></div>
  <div class="item pl-15 pr-15"><img src="{{ asset('frontend/style/images/art/z6.svg')}}" alt="" /></div>
  <div class="item pl-15 pr-15"><img src="{{ asset('frontend/style/images/art/z7.svg')}}" alt="" /></div>
  <div class="item pl-15 pr-15"><img src="{{ asset('frontend/style/images/art/z8.svg')}}" alt="" /></div>
</div>
<!-- /.owl-carousel -->
</div>
<!-- /.container -->
...
<div class="row">
  <div class="col-lg-6">
    <figure><img src="#" srcset="frontend/style/images/concept/concept13.png 1x, frontend/style/images/concept/concept13@2x.png 2x" alt="" /></figure>
</div>
<!--/column -->
<div class="space50 d-none d-md-block d-lg-none"></div>
